...
* 通常の文章入力には向いていません
* [Noto Sans](https://fonts.google.com/noto/specimen/Noto+Sans)をベースにした書体です。素晴らしい書体を制作・公開されたNoto Sansチームに感謝いたします
...
このフォントは[SIL Open Font License](https://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL)に基づいています。
